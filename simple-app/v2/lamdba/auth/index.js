...
exports.handler = function(event, context) {   
    ...
    var authResponse = {};
    var bearerToken = event.Authorization;
    if (!bearerToken)
        ...
        if (err) {
            ...
            dynamodb.getItem(params, function(err, data) {
                if (err) {
                    ...
                    authResponse.context.userId = data.Item.userId['S'].toString();
                    authResponse.context.userName = data.Item.name['S'].toString();
                    authResponse.context.userEmail = data.Item.email['S'].toString();
